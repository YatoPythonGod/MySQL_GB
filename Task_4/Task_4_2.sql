...
SELECT a.an_name AS "Название анализа", a.an_price AS "Цена анализа", o.ord_datetime AS "Дата продажи"
FROM (SELECT * FROM orders o WHERE ord_datetime BETWEEN "2020-02-05 00:00:00" AND  "2020-02-11 23:59:59") AS o
JOIN analysis a
ON o.ord_an = a.an_id
